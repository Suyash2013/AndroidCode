import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@androidcode/sdk/v2"
import { SessionTurn } from "@androidcode/ui/session-turn"
import { SessionReview } from "@androidcode/ui/session-review"
import { DataProvider } from "@androidcode/ui/context"
import { FileComponentProvider } from "@androidcode/ui/context/file"
import { WorkerPoolProvider } from "@androidcode/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@androidcode/ui/logo"
import { IconButton } from "@androidcode/ui/icon-button"
import { ProviderIcon } from "@androidcode/ui/provider-icon"
import { iife } from "@androidcode/core/util/iife"
import { Binary } from "@androidcode/core/util/binary"
import { NamedError } from "@androidcode/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@androidcode/ui/tabs"
import { MessageNav } from "@androidcode/ui/message-nav"
import { FileSSR } from "@androidcode/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@androidcode/ui/pierre/worker").then((m) => ({
