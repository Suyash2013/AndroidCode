...
import type { LLMEvent } from "@androidcode/llm"
import { LLMClient, RequestExecutor, WebSocketExecutor } from "@androidcode/llm/route"
import type { LLMClientService } from "@androidcode/llm/route"
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @androidcode/llm. It
