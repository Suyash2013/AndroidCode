import type { JsonSchema, LLMRequest, ProviderMetadata } from "@androidcode/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@androidcode/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @androidcode/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
