import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@androidcode/llm"
...
// Move this extraction into @androidcode/llm when Copilot is handled by the native runtime.
