...
export const Path = {
  // Allow override via ANDROIDCODE_TEST_HOME (or legacy OPENCODE_TEST_HOME) for test isolation
  get home() {
    return process.env.ANDROIDCODE_TEST_HOME || process.env.OPENCODE_TEST_HOME || os.homedir()
  },
  data,
